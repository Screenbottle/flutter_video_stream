...
class _SettingsPageState extends State<SettingsPage> {
  ...
  // The IP address needs to be formatted differently based on the environment
  ...
  Future<void> _loadSavedUrl() async {
    ...
    final savedUrl =
        prefs.getString('rtmp_url') ?? 'rtmp://10.0.2.2:1935/live';
    ...
    setState(() => _selectedOption = matchedPreset['label']!);
  }
  ...
  void _onPresetChanged(String? newValue) {
    ...
    setState(() {
      ...
      _controller.text = selectedPreset['value'] ?? '';
    });
  }
  ...
  Future<void> _testConnection() async {
    ...
    if (uri == null || uri.host.isEmpty || uri.port == 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Invalid RTMP URL format.')),
      );
      return;
    }
        ...
        child: ListView(
          children: [
            ...
            TextField(
              ...
              enabled: _selectedOption == 'Custom',
            ),
